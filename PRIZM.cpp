...
int PRIZM::readDigitalPin(int pin){       //============== function returns; unpressed button == 0; pressed button == 1
...
int PRIZM::readAnalogPin(int pin){       //============== function returns; unpressed button == 0; pressed button == 1
